...
//look up .filter
//change new array .push(old arr) to new arr
//cb(new array)
...
function uniq (arr, cb){
    var brandNewArr = [];
  for(let i = 0; i < arr.length; i++){
    if(brandNewArr.indexOf(arr[i]) === -1){ 
      brandNewArr.push(arr[i])
    }
  }
return cb(brandNewArr);
}//Code Here
